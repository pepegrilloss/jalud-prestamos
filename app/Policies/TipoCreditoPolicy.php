...
class TipoCreditoPolicy
{
    ...
    {
        return $user->can('view_any_tipo::credito');
    }

    /**
     * Determine whether the user can view the model.
     */
    public function view(User $user, TipoCredito $tipoCredito): bool
    {
        return $user->can('view_tipo::credito');
    }
    ...
    {
        return $user->can('create_tipo::credito');
    }
    ...
    {
        return $user->can('update_tipo::credito');
    }
    ...
    {
        return $user->can('delete_tipo::credito');
    }
