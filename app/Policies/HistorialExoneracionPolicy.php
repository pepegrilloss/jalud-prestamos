...
class HistorialExoneracionPolicy
{
    ...
    {
        return $user->can('view_any_historial::exoneracion');
    }

    /**
     * Determine whether the user can view the model.
     */
    public function view(User $user, HistorialExoneracion $historialExoneracion): bool
    {
        return $user->can('view_historial::exoneracion');
    }
    ...
    {
        return $user->can('create_historial::exoneracion');
    }

    /**
     * Determine whether the user can update the model.
     */
    public function update(User $user, HistorialExoneracion $historialExoneracion): bool
    {
        return $user->can('update_historial::exoneracion');
    }

    /**
     * Determine whether the user can delete the model.
     */
    public function delete(User $user, HistorialExoneracion $historialExoneracion): bool
    {
        return $user->can('delete_historial::exoneracion');
    }
