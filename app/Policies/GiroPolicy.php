...
class GiroPolicy
{
    ...
    {
        return $user->can('view_any_giro');
    }

    /**
     * Determine whether the user can view the model.
     */
    public function view(User $user, Giro $giro): bool
    {
        return $user->can('view_giro');
    }
    ...
    {
        return $user->can('create_giro');
    }

    /**
     * Determine whether the user can update the model.
     */
    public function update(User $user, Giro $giro): bool
    {
        return $user->can('update_giro');
    }

    /**
     * Determine whether the user can delete the model.
     */
    public function delete(User $user, Giro $giro): bool
    {
        return $user->can('delete_giro');
    }
