...
<head>
    ...
    <style>
        @page { size: 300mm 140mm; margin: 0 0 5mm 0; }
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body {
            ...
            position: relative;
            background-color: #f0f0f0; /* Color ligero para ver el papel en pantalla */
        }
        ...
        .texto-flotante {
            position: absolute;
            top: 10mm; left: 5mm; right: 5mm;
            z-index: 10;
            pointer-events: none;
        }
        .titulo { color: #008542; font-size: 13pt; font-weight: bold; margin-left: 20mm; }
        .cliente { color: #008542; font-size: 8pt; font-weight: bold; margin: 2mm 0 2mm 20mm; }
        .etiqueta-verde { color: #008542; font-weight: bold; font-size: 8pt; }
        .info-fechas { color: #008542; font-size: 8pt; font-weight: bold; margin-bottom: 2mm; }
        .zona-box { background: yellow; color: red; padding: 2px 8px; font-weight: bold; display: inline-block; font-size: 9pt; }
        ...
        @media print {
            ...
            .papel { box-shadow: none; margin: 0; }
    ...
    <div class="papel">
        <div class="texto-flotante">
            ...
            <div class="info-fechas">
                <span class="etiqueta-verde">FE:</span> {{ \Carbon\Carbon::parse($credito->FechaGeneracion)->format('d/m/Y') }}<br>
                <span class="etiqueta-verde">FV:</span> {{ $cuotas->last() ? \Carbon\Carbon::parse($cuotas->last()->FechaVencimiento)->format('d/m/Y') : '--' }}
            </div>
                        ...
                        <tbody>
                            ...
                            @foreach($items as $cuota)
                                ...
                                <tr class="{{ $debeResaltar ? 'marcado-rojo' : '' }}">
                                    ...
                                    <td></td>
                                    <td>{{ $pago > 0 ? number_format($saldoFicticio, 2) : '' }}</td>
                                </tr>
                            @endforeach
