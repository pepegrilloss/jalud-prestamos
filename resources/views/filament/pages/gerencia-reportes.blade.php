        ...
        <div class="reporte-card">
            ...
            <div class="card-body">
                <div class="card-header">
                    ...
                    <h3 class="card-title">Balance de Caja por Día</h3>
                </div>
                <p class="card-desc">Saldo histórico y movimientos del día para la sede seleccionada, incluida Caja Abierta de Gerencia.</p>
